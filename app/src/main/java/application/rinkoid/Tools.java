...
public class Tools {
    ...
    private static String GetUrl(int championship, String type) {
        ...
        case N1:
            ...
            return "http://stat.ffrs.asso.fr/stats/match/"+ type +"/2644";
        case N2N:
            // Version 2214: 2013-2014
            // Version 1812: 2014-2015
            // Version 2647: 2015-2016
            return "http://stat.ffrs.asso.fr/stats/match/"+ type +"/2647";
        case N2S:
            // Version 1853: 2013-2014
            // Version 2215: 2014-2015
            // Version 2648: 2015-2016
            return "http://stat.ffrs.asso.fr/stats/match/"+ type +"/2648";
        default:
            return "";
        }
    }
